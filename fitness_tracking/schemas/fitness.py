...
class FitnessDataExtraction(AppBaseModel):
    ...
    fitness_type: str = Field(..., description="Type of fitness activity")
    ...
    distance_km: float | None = Field(None, description="Distance covered in km")
    calories_burned: int | None = Field(None, description="Estimated calories burned")
